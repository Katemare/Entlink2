...
trait Shorthand
{
	...
	public static function get_shorthand_class($keyword)
	{
		...
		if (array_key_exists($keyword, static::$shorthand_classes)) return static::$shorthand_classes[$keyword];
	...
	protected static function gather_shorthand_classes()
	{
		...
		foreach (Engine()->get_modules() as $module)
		{
			...
			if (!empty($shorthands)) static::$shorthand_classes+=$shorthands;
		}
	}
	
	public static function from_shorthand($keyword)
	{
