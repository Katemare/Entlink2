...
{
	// FIXME: нужно как-то иначе определять, что по умолчанию следует искать в том или ином модуле, поскольку разные части модуля могут создавать страницы непосредственного класса Template_from_db или других, не приспособленных специально под модуль. Возможно, в этом как-то должен быть задействован контекст.
	...
	public function file()
	{
		// FIXME! не работает, но этот код скоро будет удалён.
