...
class Page_file_from_db extends Page_view_from_db
{
	public
		$db_key_base='file',
		$template_class='Template_page_pokeliga', // FIX: это должно неким образом ссылаться на общее текущее оформление сайта или же доставать откуда-то подходящее для случая.
