...
abstract class Convert_time extends Converter
{
	const
		FRACTION_ROUND=1,
		FRACTION_FLOOR=2,
...
class Value_timespan extends Value_time
{
	const
		DEFAULT_FORMAT='h';
...
*/
	...
	{
		$result=parent::legal_value($content);
...
class Template_period extends Template_from_db
{
	public
		$start,
		$end,
